...
The lists of input files needed at each step, can be quickly generated by using the "find" command. The lists of output file names can be generated by using "sed" (to remove "^./" and the suffix) on the input files lists.
