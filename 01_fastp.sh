...
OUTPUT2=$(sed -n "${SLURM_ARRAY_TASK_ID}p" list4.txt) ### A list of R2 output names -- I usually just capture the meaningful part of the fastq names including R2 (just remove the fq.gz or fq suffix)
